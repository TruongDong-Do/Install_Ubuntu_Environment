...
- Preferences.sublime-settings:
 `config_SublimeText.json <https://github.com/TruongDong-Do/Install_Ubuntu_Environment/blob/master/config_SublimeText.json>`__
...
.. image:: https://github.com/TruongDong-Do/Install_Ubuntu_Environment/images/torch_install.jpg
    :width: 200px
    :align: center
    :height: 100px
    :alt: alternate text
